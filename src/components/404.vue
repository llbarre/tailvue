  ...
  <div class="bg-white py-6 dark:bg-gray-900 sm:py-0">
    <div class="mx-auto max-w-screen-xl px-4 md:px-8">
      <div class="grid gap-8 sm:grid-cols-2 sm:gap-12">
        ...
        <!-- content - start -->
        <div
          class="flex flex-col items-center justify-center sm:items-start md:py-24 lg:py-32 xl:py-64"
        >
          <p
          ...
          <h1
            class="mb-2 text-center text-2xl font-bold text-gray-800 dark:text-gray-300 sm:text-left md:text-3xl"
          >
            Page not found
          </h1>

          <p
            class="mb-8 text-center text-gray-500 dark:text-gray-400 sm:text-left md:text-lg"
          >
