    ...
    <div class="bg-white dark:bg-gray-900 py-6 sm:py-8 lg:py-12">
        <div class="max-w-screen-md px-4 md:px-8 mx-auto">
            ...
            <p class="text-gray-500 sm:text-lg mb-6 md:mb-8">
                ...
                >random</a> or otherwise generated. It may be used to display a sample of fonts or generate text for testing. Filler text is dummy text which has no meaning however looks very similar to real text.
            </p>

            <h2
                class="text-gray-800 dark:text-gray-300 text-xl sm:text-2xl font-semibold mb-2 md:mb-4"
            >About us</h2>

            <p
                class="text-gray-500 dark:text-gray-200 sm:text-lg mb-6 md:mb-8"
            >This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated. It may be used to display a sample of fonts or generate text for testing. Filler text is dummy text which has no meaning however looks very similar to real text.</p>

            <ul
                class="list-disc list-inside text-gray-500 dark:text-gray-200 sm:text-lg mb-6 md:mb-8"
            >
            ...
            <blockquote
                class="text-gray-500 dark:text-gray-200 sm:text-lg italic border-l-4 pl-4 md:pl-6 mb-6 md:mb-8"
            >“This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated.”</blockquote>
            ...
            <p
                class="text-gray-500 dark:text-gray-200 sm:text-lg"
            >This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text but is random or otherwise generated. It may be used to display a sample of fonts or generate text for testing. Filler text is dummy text which has no meaning however looks very similar to real text.</p>
        </div>
    </div>
</template>
