...
<template>
  <div class="bg-white py-6 dark:bg-gray-900 sm:py-8 lg:py-12">
    <div class="mx-auto max-w-screen-md px-4 md:px-8">
      <h1
        class="mb-4 text-center text-2xl font-bold text-gray-800 dark:text-gray-300 sm:text-3xl md:mb-6"
      >
      ...
      <h2
        class="mb-2 text-xl font-semibold text-gray-800 dark:text-gray-300 sm:text-2xl md:mb-4"
      >
        About us
      </h2>
      ...
      <blockquote
        class="mb-6 border-l-4 pl-4 italic text-gray-500 dark:text-gray-200 sm:text-lg md:mb-8 md:pl-6"
      >
        “This is a section of some simple filler text, also known as placeholder
        text. It shares some characteristics of a real written text but is
